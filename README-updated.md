...
To install the actual latest "working" version via pip:

    sudo -H pip3 install --no-cache-dir https://github.com/ytdl-org/ytdl-nightly/archive/refs/tags/2024.08.07.zip

The "2024.08.07" has to be updated when there is a new release-tag for "latest".
