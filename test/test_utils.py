...
from youtube_dl.compat import (compat_chr, compat_etree_fromstring,
                               compat_getenv, compat_os_name, compat_parse_qs,
                               compat_setenv, compat_urlparse)
from youtube_dl.utils import (DateRange, ExtractorError, InAdvancePagedList,
                              OnDemandPagedList, age_restricted, args_to_str,
                              base_url, caesar, clean_html, clean_podcast_url,
                              cli_bool_option, cli_option,
                              cli_valueless_option, date_from_str,
                              detect_exe_version, determine_ext, dfxp2srt,
                              dict_get, encode_base_n, encode_compat_str,
                              ...
                              int_or_none, intlist_to_bytes, is_html,
                              js_to_json, limit_length, lowercase_escape,
                              match_str, merge_dicts, mimetype2ext,
                              month_by_name, multipart_encode,
                              ohdave_rsa_encrypt, orderedSet, parse_age_limit,
                              parse_bitrate, parse_codecs, parse_count,
                              parse_dfxp_time_expr, parse_duration,
                              ...
                              shell_quote, smuggle_url, str_to_int,
                              strip_jsonp, strip_or_none, subtitles_filename,
                              timeconvert, unescapeHTML, unified_strdate,
                              unified_timestamp, unsmuggle_url,
                              update_url_query, uppercase_escape, url_basename,
                              url_or_none, urlencode_postdata, urljoin,
                              urshift, version_tuple, xpath_attr,
