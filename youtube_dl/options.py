...
def parseOpts(overrideArguments=None):
    ...
    postproc.add_option(
         '-S','--start-second', dest='startsecond', default=0,
        help='Start second for audio clipping(Need to be used with -x option')
    postproc.add_option(
        '-T','--total-seconds', dest='totalseconds', default=None,
        help='Total number of seconds in audio clip(Need to be used with -x option')
    postproc.add_option(
