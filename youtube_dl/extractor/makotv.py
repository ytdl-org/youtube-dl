...
class MakoTVIE(InfoExtractor):
    ...
    _TEST = {
        ...
        'info_dict': {
            ...
            'thumbnail': r're:^https?://img\.mako\.co\.il/\d{4}/\d{2}/\d{2}/.*\.jpg$', # https://img.mako.co.il/2012/07/08/Parlament_01_VOD_c.jpg
    ...
    def _real_extract(self, url):
        ...
        # config = self._download_json('https://www.mako.co.il/makotv/config.json', video_id)
        # get_ticket_service = config['sources']['billing-services']['get-ticket-service']
        formats = []
