...
class CntvIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        mobj = ( re.search(r'var guid[ ="]+(?P<video_id>[a-zA-Z0-9]+)"', webpage)
            or re.search(r'"videoCenterId"[ ,"]+(?P<video_id>[a-zA-Z0-9]+)"', webpage)
            or re.search(r'"changePlayer\(\'(?P<video_id>[a-zA-Z0-9]+)\'\)\"', webpage) )
