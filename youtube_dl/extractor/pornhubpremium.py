...
class PorHubPremiumBaseIE(InfoExtractor):
    def _download_webpage_handle(self, *args, **kwargs):
        def dl(*args, **kwargs):
            return super(PorHubPremiumBaseIE, self)._download_webpage_handle(*args, **kwargs)
...
class PorHubPremiumIE(PorHubPremiumBaseIE):
    IE_DESC = 'PorHubPremium and Thumbzilla'
    _VALID_URL = r'''(?x)
                    https?://
                        (?:
    ...
    def _real_extract(self, url):
        ...
        if error_msg:
            ...
            raise ExtractorError(
                'PorHubPremium said: %s' % error_msg,
...
class PorHubPremiumPlaylistBaseIE(PorHubPremiumBaseIE):
    def _extract_entries(self, webpage, host):
        ...
        return [
            self.url_result(
                ...
                PorHubPremiumIE.ie_key(), video_title=title)
...
class PorHubPremiumPlaylistIE(PorHubPremiumPlaylistBaseIE):
...
class PorHubPremiumUserVideosIE(PorHubPremiumPlaylistBaseIE):
