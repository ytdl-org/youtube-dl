...
class TruthIE(InfoExtractor):
    ...
    def _real_extract(self, url):
        ...
        uploader_url = (
            "https://truthsocial.com/@" + uploader_id if uploader_id else None
        )
