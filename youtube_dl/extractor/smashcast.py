...
class SmashcastIE(InfoExtractor):
    IE_NAME = 'smashcast'
    _VALID_URL = r'https?://(?:www\.)?smashcast\.tv/(?:[\w\d\-]+/)?videos?/(?P<id>[0-9]+)'
    _TEST = {
        'url': 'http://www.smashcast.tv/video/203213',
        'info_dict': {
            'id': '203213',
            ...
            'duration': 215.1666,
            'resolution': None, #Quick bodge, originally 'HD 720p'
            'uploader': 'hitboxlive',
            'view_count': int,
