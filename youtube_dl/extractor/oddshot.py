...
class OddshotIE(InfoExtractor):
	_VALID_URL = r'(?:https?://)?(?:www\.)?oddshot\.tv/s(hot)?(/.+)?/(?P<id>.+)'
	_TESTS = [
		{
			'url': 'https://oddshot.tv/s/TAUv5m',
		...
		{
			'url': 'https://oddshot.tv/s/TAUv5m',
			'md5': '0553b234670be27d96da10066fabc052',
			'info_dict': {
				'id': 			'TAUv5m',
				'ext':			'mp4',
				'title': 		'ELEAGUE CLASH FOR CASH CS:GO THE REMATCH',
				'description':	'Youtube - ELEAGUE'
			}
		}
	]
