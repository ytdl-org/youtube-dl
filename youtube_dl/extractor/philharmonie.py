...
class PhilharmonieTvIE(InfoExtractor):
    ...
    _TEST = {
        ...
        'md5': '494b1e6605767f0d5bb141f879de1813',
        'info_dict': {
            'id': '26',
            'ext': 'flv',
            ...
            'description': 'Trailer zum Livestram am 03.05.2016 Tuesday 20:00h, Konzert vom 03.05. ACHT BRÜCKEN | Musik für Köln.  Hauschka, G. Schwellenbach, D. Brandt, P. Frick, E. Sarp, J. Farah: Reich',
        }
    }
